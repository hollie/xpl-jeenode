// Door node. Used to control the door lights, notify motion at the front door
// and report temperature.
// Very heavily based on the Room node code, I just added 'never sleep' behaviour
// and a single output to drive the LEDs at my front door. 
